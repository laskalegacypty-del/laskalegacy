...
export async function recordStallSale(eventId, stallItemId) {
  ...
  const { data: item, error: rpcError } = await supabase.rpc('decrement_stall_stock', { p_item_id: stallItemId }).single();
